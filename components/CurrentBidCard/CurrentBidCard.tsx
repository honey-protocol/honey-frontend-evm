...
const CurrentBidCard = (props: CurrentBidCardProps) => {
	const { fetchedTokenPrice, date, usdValue, tokenAmount, walletAddress, hasBorder = true } = props;
	...
	return (
		<div className={c(styles.bidCard, { [styles.hasBorder]: hasBorder })}>
			...
			<div className={styles.bidCardRight}>
				...
				<p className={styles.bidCardUsdcCounts}>{f(usdValue * fetchedTokenPrice)} USD</p>
			</div>
		</div>
	);
};
