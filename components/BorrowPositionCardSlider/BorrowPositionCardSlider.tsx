...
export const BorrowPositionCardSlider: FC<BorrowPositionCardSliderProps> = ({
	...
	const liquidateZone = 1 - maxAvailableValue - safeZone - riskLevel;
	...
	return (
		<div className={styles.rangeContainer}>
			{isLiquidate ? (
				<>
					<div className={styles.sliderWrapper} style={{ width: `${riskLevel * 100}%` }}>
				...
				<>
					...
					{maxAvailableValue > 0 && (
						<div className={styles.sliderWrapper} style={{ width: `${maxAvailableValue * 100}%` }}>
