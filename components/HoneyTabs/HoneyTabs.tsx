	...
	return (
		<div className={styles.tabs}>
			<div className={styles.tabsNav}>
				{props.activeKey === props.items[0].key ? <TabBgLeft /> : <TabBgRight />}
				...
				{props.items.map((tabInfo, i) => (
					<div
						...
						onClick={() => (tabInfo.disabled ? null : props.onTabChange(tabInfo.key))}
					>
						<Typography.Text className={styles.tabText}>{tabInfo.label}</Typography.Text>
					</div>
				))}
			</div>
