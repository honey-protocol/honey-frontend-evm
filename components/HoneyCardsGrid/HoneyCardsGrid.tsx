    ...
    <div className={styles.honeyCardsGrid}>
      ...
      <div className={styles.gridFilters}>
        <div className={styles.mobilePageTitle}>
          <div className={c(styles.pageTitle, styles.showMobile)}>
            My assets
          </div>
            ...
            ? borrowedPositions.map((position, index) => {
                return (
                  <BorrowPositionCard
                    ...
                    key={index}
                    onSelect={() =>
                      initLoanOrBorrowFlow(position.tokenId, position.couponId)
                    }
                  />
                );
              })
